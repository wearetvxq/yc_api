...
def upload_delete_delete(id):  # noqa: E501
    """User Upload
...
def upload_post(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        try:
            ...
            YCimport.insert(path=body.url, type=body.type, name=body.name, posttime=int(time.time())).execute()
        ...
        try:
            ...
            print ('------------')
            import_sql(body.url,getfiletype(body.type),pid=pid)
